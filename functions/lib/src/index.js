...
async function handleProfileMyItems(req, res) {
    try {
        ...
        if (type === "all" || type === "selling") {
            // 판매중인 상품 (active 상태)
            const sellingQuery = (0, firestore_1.query)((0, firestore_1.collection)(firebase_1.db, "items"), (0, firestore_1.where)("sellerUid", "==", userId), (0, firestore_1.where)("status", "==", "active"));
            const sellingSnapshot = await (0, firestore_1.getDocs)(sellingQuery);
        ...
        if (type === "all" || type === "trading") {
            ...
            const sellerTradingQuery = (0, firestore_1.query)((0, firestore_1.collection)(firebase_1.db, "items"), (0, firestore_1.where)("sellerUid", "==", userId), (0, firestore_1.where)("status", "in", [
                "reserved",
                "paid_hold",
                "shipping",
                "escrow_completed",
            ]));
            const buyerTradingQuery = (0, firestore_1.query)((0, firestore_1.collection)(firebase_1.db, "items"), (0, firestore_1.where)("buyerUid", "==", userId), (0, firestore_1.where)("status", "in", [
                "reserved",
                "paid_hold",
                "shipping",
                "escrow_completed",
            ...
            const [sellerTradingSnapshot, buyerTradingSnapshot] = await Promise.all([
                (0, firestore_1.getDocs)(sellerTradingQuery),
                (0, firestore_1.getDocs)(buyerTradingQuery),
            ]);
            // 판매자 관점 거래중 상품 추가
        ...
        if (type === "all" || type === "buying") {
            ...
            const buyingUidQuery = (0, firestore_1.query)((0, firestore_1.collection)(firebase_1.db, "items"), (0, firestore_1.where)("buyerUid", "==", userId), (0, firestore_1.where)("status", "in", [
                "reserved",
                "paid_hold",
                "shipping",
                "escrow_completed",
            ]));
            const buyingIdQuery = (0, firestore_1.query)((0, firestore_1.collection)(firebase_1.db, "items"), (0, firestore_1.where)("buyerId", "==", userId), (0, firestore_1.where)("status", "in", [
                "reserved",
                "paid_hold",
                "shipping",
                "escrow_completed",
            ...
            const [buyingUidSnapshot, buyingIdSnapshot] = await Promise.all([
                (0, firestore_1.getDocs)(buyingUidQuery),
                (0, firestore_1.getDocs)(buyingIdQuery),
            ]);
            // buyerUid로 찾은 상품들 추가
        ...
        if (type === "sold") {
            ...
            const sellerSoldQuery = (0, firestore_1.query)((0, firestore_1.collection)(firebase_1.db, "items"), (0, firestore_1.where)("sellerUid", "==", userId), (0, firestore_1.where)("status", "==", "sold"));
            const buyerSoldQuery = (0, firestore_1.query)((0, firestore_1.collection)(firebase_1.db, "items"), (0, firestore_1.where)("buyerUid", "==", userId), (0, firestore_1.where)("status", "==", "sold"));
            const [sellerSoldSnapshot, buyerSoldSnapshot] = await Promise.all([
                (0, firestore_1.getDocs)(sellerSoldQuery),
                (0, firestore_1.getDocs)(buyerSoldQuery),
            ]);
            // 판매자 관점 거래완료 상품 추가
